from server.core.burp_context_service import get_logger_deltas
...
TOOL = ToolDefinition(
    name="get_logger_deltas",
    description="Return bounded Logger evidence deltas and references for the supplied payload.",
    input_schema={
        "type": "object",
        "properties": {
